...
const ColumnController_1 = require("../../ColumnController/ColumnController");
const EditorFrontHostApp_1 = require("../../../EditorFrontHostApp/EditorFrontHostApp");
const common_1 = require("../../../../common");
const NewColumnController_1 = require("../../../ModalController/NewColumnController/NewColumnController");
const NewFormFromTableController_1 = require("../../../ModalController/NewFormFromTableController/NewFormFromTableController");
...
class TableController extends DocumentController_1.DocumentController {
    ...
    createColumn(model) {
        const column = new ColumnController_1.ColumnController(model, this);
        column.init();
