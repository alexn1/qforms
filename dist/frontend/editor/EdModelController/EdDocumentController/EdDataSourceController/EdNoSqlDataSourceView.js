...
exports.EdNoSqlDataSourceView = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const React = __importStar(require("react"));
const EdDocumentView_1 = require("../EdDocumentView");
const common_1 = require("../../../../common");
require("./EdNoSqlDataSourceView.less");
class EdNoSqlDataSourceView extends EdDocumentView_1.EdDocumentView {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        this.selectQuery = EdDocumentView_1.EdDocumentView.createCM(this.selectRef.current, ctrl.model.getAttr('selectQuery'));
...
exports.EdNoSqlDataSourceView = EdNoSqlDataSourceView;
