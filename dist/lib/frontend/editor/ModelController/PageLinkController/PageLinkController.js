...
const PageController_1 = require("../DocumentController/VisualController/PageController/PageController");
class PageLinkController extends ModelController_1.ModelController {
    ...
    async loadPage() {
        ...
        page.init();
        // pageController
        const pageController = new PageController_1.PageController(page, this);
        pageController.init();
