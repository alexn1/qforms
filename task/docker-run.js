...
async function main() {
    ...
    await Lib.exec(
        `docker run -e LISTEN_HOST=0.0.0.0 -e DB_HOST=host.docker.internal -e APPS_DIR_PATH=/apps -p 7000:7000 -v qforms-apps:/app/apps -v ~/projects/qforms-apps:/apps -v qforms-runtime:/app/runtime --rm qforms:${version}`,
    );
}
