...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.moveUp = function() {
    var self = this;
    var args = {
        controller: 'Form',
        action    : 'moveUp',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.moveDown = function() {
    var self = this;
    var args = {
        controller: 'Form',
        action    : 'moveDown',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.newField = function(params) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.newControl = function(params) {
    var self = this;
    params['pageFileName'] = self.page.pageLink.data['@attributes'].fileName;
    params['form']         = self.data['@attributes'].name;
    var args = {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.newDataSource = function(params) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.createController = function() {
    var self = this;
    var args = {
        controller: 'Form',
