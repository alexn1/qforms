...
////////////////////////////////////////////////////////////////////////////////////////////////////
FormController.prototype.fill2 = function(context) {
    var self = this;
    if (self.data.dataSources.default) {
        return FormController.super_.prototype.fill2.call(self, context);
    } else {
        var dataSourceResponse = self._getSurrogateDataSourceResponse(context);
        self.dumpRowToParams(dataSourceResponse.rows[0], context.querytime.params);
        return FormController.super_.prototype.fill2.call(self, context).then(function (response) {
            response.dataSources.default = dataSourceResponse;
            return response;
        });
    }
