...
util.inherits(Application, ModelController);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.create2 = function(appFilePath) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype._buildMenu2 = function(context) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype.init2 = function() {
    var self = this;
    return Application.super_.prototype.init2.call(self).then(function () {
        return self._createStartupPages2().then(function () {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype.deinit2 = function() {
    var self = this;
    console.log('Application.prototype.deinit2: ' + self.name);
    return Promise.each(Object.keys(self.databases), function (name) {
        var database = self.databases[name];
        return database.deinit2();
    });
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype._createPage2 = function(pageName) {
    var self = this;
    return Promise.try(function () {
        ...
        var data = JSON.parse(content);
        return qforms.Page.create2(data, self);
    }).then(function (page) {
        return page.init2().then(function () {
            return page;
        });
    });
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype.getPage2 = function(context, pageName) {
    var self = this;
    return Promise.try(function () {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype._createStartupPages2 = function() {
    var self = this;
    return Promise.try(function () {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Application.prototype.fill2 = function(context) {
    var self = this;
    return Application.super_.prototype.fill2.call(self, context).then(function (response) {
        ...
        return self._buildMenu2(context).then(function (menu) {
            response.menu  = menu;
            response.pages = {};
