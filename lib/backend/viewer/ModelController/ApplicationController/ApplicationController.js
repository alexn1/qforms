...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.deinit2 = function() {
    var self = this;
    console.log('ApplicationController.prototype.deinit2: ' + self.name);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.fill2 = function(context) {
    var self = this;
    return ApplicationController.super_.prototype.fill2.call(self, context).then(function (response) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.authenticate2 = function(context, username, password) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.getUsers2 = function(context) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.createContext = ApplicationController.createContext =  function(context) {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ApplicationController.prototype.destroyContext = ApplicationController.destroyContext = function(context) {
