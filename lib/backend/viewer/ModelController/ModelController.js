...
////////////////////////////////////////////////////////////////////////////////////////////////////
Model.prototype.init2 = function() {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Model.prototype.fill2 = function(context) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Model.prototype._fillCollections2 = function(response, context) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Model.prototype.createCollection2 = function(colName) {
    var self = this;
    //console.log('Model.prototype.createCollection2', colName);
    return Promise.try(function () {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Model.prototype.fillCollection2 = function(response, colName, context) {
    var self = this;
    return Promise.try(function () {
        if (self[colName]) {
            response[colName] = {};
