...
////////////////////////////////////////////////////////////////////////////////////////////////////
Form.prototype.fill = function(context) {
    var self = this;
    if (self.data.dataSources.default) {
        return Form.super_.prototype.fill.call(self, context);
    } else {
        ...
        return Form.super_.prototype.fill.call(self, context).then(function (response) {
