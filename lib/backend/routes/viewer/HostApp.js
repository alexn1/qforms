...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.handle = function (req, res) {
    var self = this;
    //console.log('HostApp.prototype.handle', req.method);
    var route = [req.params.appDirName, req.params.appFileName].join('/');
    if (req.method === 'GET') {
        if (self.application.authentication() && !(req.session.user && req.session.user[route])) {
            self.login(req, res);
        } else {
            self.index(req, res);
        }
        ...
        if (req.body.action === 'login') {
            ...
            if (self.application.authentication() && !(req.session.user && req.session.user[route])) {
                ...
                if (ACTIONS.indexOf(req.body.action) !== -1) {
                    eval('self.{action}(req, res)'.replace('{action}', req.body.action));
                } else {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.login = function (req, res) {
    var self = this;
    console.log('HostApp.prototype.login');
    var route = [req.params.appDirName, req.params.appFileName].join('/');
    var context = self.application.createContext({
        req: req
    });
    if (req.method === 'GET') {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.logout = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.index = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.page = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.update = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.frame = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.insert = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype._delete = function (req, res) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
HostApp.prototype.rpc = function (req, res) {
    var self = this;
