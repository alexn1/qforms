        ...
        switch (params.view) {
            case 'VisualView.html':
                return self.getApplicationEditor2().then(function(appEditor) {
                    return appEditor.getPage2(params.page).then(function (pageEditor) {
                        var formEditor = pageEditor.getForm(params.form);
                        return formEditor.getCustomFile2('ejs').then(function (ejs) {
                            result.data.ejs = ejs;
                            return formEditor.getCustomFile2('css').then(function (css) {
                                result.data.css = css;
                                return formEditor.getCustomFile2('js').then(function (js) {
                                    result.data.js = js;
                                    return result;
                                });
                            });
...
FormEditorController.prototype.saveView = function(params) {
    ...
    return self.getApplicationEditor2().then(function(appEditor) {
        return appEditor.getPage2(params.page).then(function (pageEditor) {
            ...
            switch (params.view) {
                case 'ejs':
                    formEditor.saveCustomFile2('ejs', params.text).then(function () {
                        return null;
                    });
                    break;
                case 'css':
                    formEditor.saveCustomFile2('css', params.text).then(function () {
                        return null;
                    });
                    break;
            }
...
FormEditorController.prototype.saveController = function(params) {
    ...
    return self.getApplicationEditor2().then(function(appEditor) {
        return appEditor.getPage2(params.page).then(function (pageEditor) {
            var formEditor = pageEditor.getForm(params.form);
            return formEditor.saveCustomFile2('js', params.text).then(function () {
                return null;
            });
        });
    });
