...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
PageEditor.prototype.setAttr2 = function(name, value) {
    var self = this;
    if (name === 'name') {
        var pageName = self.pageFile.getAttr('name');
        var pageLinkEditor = self.appEditor.getPageLink(pageName);
        return pageLinkEditor.setAttr2(name, value).then(function () {
...
PageEditor.prototype.moveFormUp2 = function(params) {
    var self = this;
    self.data.forms = qforms.helper.moveObjProp(this.data.forms, params.form, -1);
    return self.save2().then(function () {
        return 'ok';
    });
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////
PageEditor.prototype.save2 = function() {
    var self = this;
    return self.pageFile.save2();
};
...
PageEditor.prototype.createEjs2 = function(params) {
    ...
    return self.getCustomFilePath2('ejs').then(function (customEjsFilePath) {
        return self.createFileByReplace2(customEjsFilePath, self.defaultEjsFilePath, self.getViewName(), params.page, null).then(function (ejs) {
            return ejs;
        });
    });
};
...
PageEditor.prototype.createCss2 = function(params) {
    ...
    return self.getCustomFilePath2('css').then(function (customCssFilePath) {
        ...
        return self.createFileByReplace2(customCssFilePath, self.defaultCssFilePath, self.getViewName(), params.page, emptyTemplate).then(function (css) {
            return css;
        });
    });
};
