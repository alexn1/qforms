...
Application.prototype.init = function() {
    ...
    for (var name in this.data.pages) {
        ...
        //e.track = false;
        //e.select = false;
        //this.eventPageOpened.fire({source: this, page: page, track: false, select: false});
        self.emit('pageOpened', {source: this, page: page, track: false, select: false});
    }
};
...
Application.prototype.openPage = function(args) {
    ...
    if (page !== null) {
        ...
        //ea.page = page;
        //self.eventPageSelected.fire({source: self, page: page});
        ...
        return QForms.doHttpRequest2(args).then(function (response) {
            self.lastPageId++;
...
Application.prototype.saveAndClosePage = function(page) {
    ...
    //ea.page = page;
    //this.eventPageClosed.fire({source: this, page: page});
