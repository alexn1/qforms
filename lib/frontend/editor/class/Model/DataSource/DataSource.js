...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.create2 = function(parent, params) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.setValue2 = function(name, value) {
    var self = this;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.delete2 = function() {
    var self = this;
    var args = {
        controller: 'DataSource',
        action    : 'delete',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.moveUp2 = function() {
    var self = this;
    var args = {
        controller: 'DataSource',
        action    : 'moveUp',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.getView2 = function(view) {
    var self = this;
    var args = {
        controller: 'DataSource',
        action    : 'getView',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.saveController2 = function(text) {
    var self = this;
    var args = {
        controller: 'DataSource',
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DataSource.prototype.createController2 = function() {
    var self = this;
    var args = {
        controller: 'DataSource',
