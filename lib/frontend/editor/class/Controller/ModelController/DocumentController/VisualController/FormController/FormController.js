...
FormController.prototype.actionNewField = function() {
    var self = this;
    Field.prototype.getView2('new.html').then(function (result) {
        $(document.body).append(result.view);
        $('#myModal').on('hidden.bs.modal', function(e){$(this).remove();});
        $("#myModal button[name='create']").click(function() {
            ...
            self.model.newField2(params).then(function (fieldData) {
...
FormController.prototype.actionNewControl = function() {
    var self = this;
    Control.prototype.getView2('new.html').then(function (result) {
        $(document.body).append(result.view);
        ...
        $("#modal button[name='create']").click(function() {
            ...
            self.model.newControl2(params).then(function (controlData) {
