...
ApplicationController.prototype.newPageAction = function() {
    var self = this;
    Page.prototype.getView2('new.html').then(function (result) {
        ...
        $("#myModal button[name='create']").click(function() {
            ...
            self.model.newPage2(params).spread(function (pageData, pageLinkData) {
...
ApplicationController.prototype.newDataSourceAction = function() {
    ...
    DataSource.prototype.getView2('new.html').then(function (result) {
        ...
        $("#myModal button[name='create']").click(function() {
            ...
            self.model.newDataSource2(params).then(function (dataSourceData) {
...
ApplicationController.prototype.newDatabaseAction = function() {
    var self = this;
    Database.prototype.getView2('new.html').then(function (result) {
        $(document.body).append(result.view);
        $('#myModal').on('hidden.bs.modal', function(e){$(this).remove();});
        $("#myModal button[name='create']").click(function() {
            ...
            self.model.newDatabase2(params).then(function (databaseData) {
