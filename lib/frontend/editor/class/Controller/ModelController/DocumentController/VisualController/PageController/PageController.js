...
PageController.prototype.doAction = function(action) {
    ...
    switch (action) {
        ...
        case 'delete':
            ...
            break;
        case 'moveUp':
            self.model.pageLink.moveUp2().then(function (data) {
                self.item.move(-1);
            });
            break;
        case 'moveDown':
            self.model.pageLink.moveDown2().then(function (data) {
                self.item.move(1);
            });
            break;
        default:
...
PageController.prototype.actionNewForm = function() {
    ...
    Form.prototype.getView2('new.html').then(function (result) {
        ...
        $("#myModal button[name='create']").click(function() {
            ...
            self.model.newForm2(params).then(function (formData) {
...
PageController.prototype.newDataSourceAction = function() {
    ...
    DataSource.prototype.getView2('new.html').then(function (result) {
        ...
        $("#myModal button[name='create']").click(function() {
            ...
            DataSource.create2(self.model, params).then(function (dataSourceData) {
