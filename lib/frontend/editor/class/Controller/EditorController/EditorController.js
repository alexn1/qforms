...
EditorController.prototype.onItemSelect = function(e) {
    ...
    if (e.item.ctrl) {
        if (e.item.ctrl instanceof PageLinkController) {
            self.pageLinkToPage2(e.item).then(function() {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
EditorController.prototype.pageLinkToPage2 = function(item) {
    var self = this;
    ...
    return QForms.doHttpRequest2(args).then(function (pageData) {
