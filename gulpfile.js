...
gulp.task('frontend_common_class', gulp.series('frontend_common_class_js', 'frontend_common_class_css'));
gulp.task('frontend_common', gulp.series('frontend_common_class', 'frontend_common_img', 'frontend_common_lib'));
...
gulp.task('frontend_editor_class', gulp.series('frontend_editor_class_js', 'frontend_editor_class_css', 'frontend_editor_class_ejs', 'frontend_editor_class_html'));
gulp.task('frontend_editor', gulp.series('frontend_editor_class', 'frontend_editor_lib'));
...
gulp.task('frontend_home_class', gulp.series('frontend_home_class_js', 'frontend_home_class_css'));
gulp.task('frontend_home', gulp.series('frontend_home_class', 'frontend_home_html'));
...
gulp.task('frontend_viewer_class', gulp.series('frontend_viewer_class_js', 'frontend_viewer_class_css', 'frontend_viewer_class_ejs'));
